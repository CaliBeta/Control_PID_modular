...
Kp=(den_deseada_orden_3(3)-2)/(4)   
Ti=4*Kp/den_deseada_orden_3(4)
Td=(den_deseada_orden_3(2)-1)/(4*Kp)


%% probando los parametros calculados con la funcion step

%------- la planta controlada --------------
num_controlada= [4*Kp*Td, 4*Kp, (4*Kp)/(Ti)]
den_controlada=[1, 1+4*Kp*Td, 4*Kp+2, (4*Kp)/(Ti)] 
